...
export const modalVerbs: ModalVerb[] = [
  ...
  },
  {
    similar: "must",
    modal: "Have to",
    meaning: "Kewajiban moral",
    usage: ["Kewajiban moral", "Kemungkinan", "Kritik halus"],
    examples: [
      "I have to finish my homework.",
      "We have to attend the meeting.",
      "The plane has to land on time.",
  ...
  },
  {
    ...
    usage: ["Kewajiban moral", "Kemungkinan", "Kritik halus"],
    examples: [
      "You ought to try this new restaurant.",
      "He ought to be more careful with his money.",
      "The government ought to invest more in education.",
    ],
    formality: "Formal",
  },
  {
